...
// fns de los cálculos
const vlrSubtotal = (precio,cantidad) => precio*cantidad
const vlrDescuento = (vlrSubtotal) => vlrSubtotal*0.10
const vlrIva = (vlrSubtotal,vlrDescuento) => (vlrSubtotal-vlrDescuento)*0.19
const vlrNeto = (vlrSubtotal,vlrDescuento,vlrIva) => vlrSubtotal-vlrDescuento+vlrIva
